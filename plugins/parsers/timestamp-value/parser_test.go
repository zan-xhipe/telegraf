...
func TestParseDefaultTimeLayout(t *testing.T) {
...
func TestParseMultipleValuesDefaultTimeLayout(t *testing.T) {
	parser := TimestampValueParser{
...
func TestParseLineDefaultTimeLayout(t *testing.T) {
	parser := TimestampValueParser{
		MetricName: "timestamp_value_test",
		DataType:   "integer",
	}
...
func TestParseInvalidDefaultLayout(t *testing.T) {
	parser := TimestampValueParser{
		MetricName: "timestamp_value_test",
		DataType:   "integer",
	}
...
func TestParseLineInvalidDefaultLayout(t *testing.T) {
	parser := TimestampValueParser{
		MetricName: "timestamp_value_test",
		DataType:   "integer",
	}
